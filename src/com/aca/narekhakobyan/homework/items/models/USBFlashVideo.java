...
public class USBFlashVideo extends Gadget implements Video {
    ...
    public USBFlashVideo(FormatVideo formatVideo, VideoQuality videoQuality, Integer recDuration, Integer price, Integer count) {
        super(recDuration, price, count);
        this.formatVideo = formatVideo;
        this.videoQuality = videoQuality;
    }

    public static USBFlashVideo initFromFile() {
        final Path inputFilePath = Paths.get("src\\com\\aca\\narekhakobyan\\homework\\input\\USBFlashVideoProducts.csv");
        ...
        try (BufferedReader bufferedReader = new BufferedReader(new FileReader(inputFilePath.toFile()))) {
            ...
            while ((row = bufferedReader.readLine()) != null) {
                ...
                if (productDetails.length == 5) {
                    USBFlashVideo usbFlashVideo = new USBFlashVideo(FormatVideo.valueOf(productDetails[3]),
