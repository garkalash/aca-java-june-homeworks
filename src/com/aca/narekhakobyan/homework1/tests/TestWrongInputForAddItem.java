...
public class TestWrongInputForAddItem {
    public final void RunTest() {
        ArrayList<Gadget> gadgets = new ArrayList<>();

        GadgetManager manager = new GadgetManager(gadgets);
        manager.addItem(new GadgetVideoWithoutMemory("Pen Video", -6500, 2, FormatVideo.MP4,
                VideoQuality.VGA, 1));
        manager.addItem(new GadgetRecordWithMemory("Pen Record", 14000, -9, 8,
                FormatSound.MP3, 1));
        manager.addItem(new GadgetRecordWithMemory("USB FLASH", 11000, 9, -8,
                FormatSound.MP3, 1));
        manager.addItem(new GadgetVideoWithoutMemory("USB FLASH", 5000, 2, FormatVideo.MP4,
                VideoQuality.VGA, -1));
        manager.addItem(new GadgetRecordVideoWithMemory("Watch", 13000, 8, 5,
