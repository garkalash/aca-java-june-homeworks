...
public class Main {
    public static void main(String[] args) {
        ...
        armenia.getCities().addAll(Arrays.asList(yerevan,gyumri,vanadzor));
        ...
        usa.getCities().addAll(Arrays.asList(washington,newYork,atlanticCity));
        ...
        france.getCities().addAll(Arrays.asList(paris,lyon,nantes));
